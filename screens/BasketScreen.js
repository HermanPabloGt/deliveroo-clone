      ...
      <View className="flex-1 bg-gray-100">
        <View className="p-5 border-b border-[#00CCBB] bg-white shadow-sm" >
          ...
          <TouchableOpacity onPress={navigation.goBack} className="rounded-full bg-gray-100 absolute top-3 right-5">
            <XCircleIcon color="#00CCBB" height={30} width={30}></XCircleIcon>
          </TouchableOpacity>
        </View>
        <View className="flex-row items-center space-x-4 px-4 py-3 bg-white my-5">
          <Image
            source={{uri: "https://links.papareact.com/wru"}} className="h-7 w-7 bg-gray-300 p-4 rounded-full"></Image>
        ...
        <View className="p-5 bg-white mt-5 space-y-4">
          ...
          <View className="flex-row justify-between">
            ...
            <Text className="text-gray-400">
              <Currency quantity={5} currency="GBP"></Currency>
            </Text>
          </View>
          <View className="flex-row justify-between">
            <Text >Order Total</Text>
            <Text className="font-extrabold">
              <Currency quantity={basketTotal + 5} currency="GBP"></Currency>
            </Text>
          </View>
